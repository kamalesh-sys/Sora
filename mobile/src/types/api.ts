...
export type LoanType = "personal" | "home" | "business" | "vehicle" | "education" | "credit" | "other";
export type LoanInterestType = "none" | "simple";
export type LoanRepaymentFrequency = "one_time" | "weekly" | "monthly" | "custom";
...
export type Loan = {
  ...
  principal_progress_percent: string;
...
export type SaveLoanPaymentPayload = {
  amount: string;
  payment_date: string;
  payment_method?: PaymentMethod;
  principal_amount?: string;
...
export type LoanPaymentMutationResult = {
  loan: Loan;
  payment?: LoanPayment;
};
